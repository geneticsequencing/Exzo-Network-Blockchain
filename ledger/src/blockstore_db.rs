...
pub enum BlockstoreError {
    ...
    Other(&'static str), // TODO(exzo): remove, use specific error variant
}
...
impl Rocks {
    fn open(
        ...
        // this is only needed for LedgerCleanupService. so guard with PrimaryOnly (i.e. running exzo-validator)
