use {
    ...
    solana_sdk::{genesis_config::GenesisConfig, native_token::LAMPORTS_PER_XZO},
};
...
pub const CREATOR_STAKER_INFOS: &[StakerInfo] = &[
    StakerInfo {
        ...
        lamports: 5_000_000 * LAMPORTS_PER_XZO,
    ...
    StakerInfo {
        ...
        lamports: 1_205_602 * LAMPORTS_PER_XZO,
    ...
    StakerInfo {
        ...
        lamports: 3_655_292 * LAMPORTS_PER_XZO,
    ...
    StakerInfo {
        ...
        lamports: 103_519 * LAMPORTS_PER_XZO,
    ...
    StakerInfo {
        ...
        lamports: 3_880_295 * LAMPORTS_PER_XZO,
...
pub const SERVICE_STAKER_INFOS: &[StakerInfo] = &[
    StakerInfo {
        ...
        lamports: 225_000 * LAMPORTS_PER_XZO,
...
pub const FOUNDATION_STAKER_INFOS: &[StakerInfo] = &[
    ...
    StakerInfo {
        ...
        lamports: 57_500_000 * LAMPORTS_PER_XZO,
...
pub const GRANTS_STAKER_INFOS: &[StakerInfo] = &[
    ...
    StakerInfo {
        ...
        lamports: 15_000_000 * LAMPORTS_PER_XZO,
...
pub const COMMUNITY_STAKER_INFOS: &[StakerInfo] = &[
    ...
    StakerInfo {
        ...
        lamports: 30_301_032 * LAMPORTS_PER_XZO,
    ...
    StakerInfo {
        ...
        lamports: 153_333_633 * LAMPORTS_PER_XZO + 41 * LAMPORTS_PER_XZO / 100,
...
pub fn add_genesis_accounts(genesis_config: &mut GenesisConfig, mut issued_lamports: u64) {
    ...
    // "one thanks" (community pool) gets 500_000_000XZO (total) - above distributions
    create_and_add_stakes(
        genesis_config,
        &StakerInfo {
            name: "one thanks",
            staker: "7vEAL3nS9CWmy1q6njUUyHE7Cf5RmyQpND6CsoHjzPiR",
            lamports: (500_000_000 * LAMPORTS_PER_XZO).saturating_sub(issued_lamports),
...
mod tests {
    ...
    fn test_add_genesis_accounts() {
        ...
        assert_eq!(500_000_000 * LAMPORTS_PER_XZO, lamports);
    }
}
