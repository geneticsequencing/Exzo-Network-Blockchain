...
pub fn entrypoint(
    ...
    let precompiles = match activate_precompile {
        PrecompileSet::ExzoClassic => &PRECOMPILES_MAP_DEPRECATED,
        PrecompileSet::ExzoNext => &PRECOMPILES_MAP,
...
mod test {
    ...
    fn call_to_sha256() {
        ...
        AccountStructure::testing(0, |accounts: AccountStructure| {
            let precompiles = entrypoint(accounts, PrecompileSet::ExzoClassic, false);
            let input = [0u8; 0];
    ...
    fn call_modexp() {
        ...
        // // this test is slow
        // AccountStructure::testing(0, |accounts| {
        //     let precompiles = entrypoint(accounts, ActivatePrecompile::ExzoNext);
        //     let input = hex!(
        //         "
        ...
        AccountStructure::testing(0, |accounts| {
            let precompiles = entrypoint(accounts, PrecompileSet::ExzoNext, false);
            let input = hex!(
                "
